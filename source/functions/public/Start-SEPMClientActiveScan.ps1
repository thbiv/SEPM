Function Start-SEPMClientActiveScan {
    <#
    .SYNOPSIS
    ...
    $URL = "https://{0}:{1}/sepm/api/v1/command-queue/activescan" -f $ComputerName,$Port
    $Header = @{
    ...
    If ($PSCmdlet.ShouldProcess('Send Command to Start Active Scan')) {
